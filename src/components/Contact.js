...
async editDataFetch(contact){
	...
	render() {
		...
		if(this.state.status=='show'){
		 	contactNode =	<div className='pt-2 px-4 my-3 mr-5  d-flex flex-column justify-content-center align-items-between main-wrapper  w-100'>
			<div className='d-flex flex-row flex-wrap justify-content-between '>
				...
				<div className='actions d-flex pr-3 align-items-center justify-content-center'>
				 	...
				 	<Modal clickHandler={this.props.deleteHandler} contact={contact}/>
				 </div>				
			</div>
		 ...
		 contactNode =	<div className=' pt-2 d-flex flex-column justify-content-center align-items-between main-wrapper w-100'>
